...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// That nested function uses closure.  I can tell because there is a function inside of another function, and the inner function is accessing the variable that is outside of it's scope but inside of the original function's scope. Even when the original myFunction() is finished running, the nested function can access the variables using closure.
...
console.log(animalNames(zooAnimals))
  ...
  */
  ...
  console.log(USApop(zooAnimals)) //looking for 55
